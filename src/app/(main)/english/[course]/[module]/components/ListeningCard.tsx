...
const ListeningCard = ({ id, number, question, options, context, setAnswer, userAnswers }: ListeningCardProps) => {
            ...
            <div className="w-full flex justify-between gap-4">
                {
                    options.map((option, index) => (
                        <div key={index} className="flex justify-between items-center w-full max-w-[268px] bg-[#F7F6F9] p-3 rounded-2xl"
                             onClick={() => {
