    ...
    return (
        <ModalCard onClose={onClose}>
            <div className="w-full text-[#3B3E4B] ">
                ...
                <p className="text-xs mb-9">Бұл Тесттер сіздің жауаптарыңызды анықтау арқылы, деңгейіңізді нақтылайтын болады</p>
                <div className="w-full flex flex-col gap-9">
                    ...
                    <div className="w-full flex justify-center">
                        <Button label={isLoading ? "Жіберілуде" : "Тексеру"} onClick={handleSubmit} disabled={isLoading}
                                width={134} height={44}/>
                    </div>
